import{n as e,r as t,t as n}from"./index-5dsXtgsz.js";var r=t(e(),1),i=`<div class="top-progress" id="top-progress"></div>
...
`,a=n(),o=[`https://cdn.jsdelivr.net/npm/hls.js@latest`,`https://cdn.plyr.io/3.8.4/plyr.js`,`https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.16.105/pdf.min.js`,`/dominic-app.js`];function s(e){return new Promise((t,n)=>{let r=document.querySelector(`script[data-dominic-src="${e}"]`);if(r){r.dataset.loaded===`1`?t():r.addEventListener(`load`,()=>t(),{once:!0});return}let i=document.createElement(`script`);i.src=e,i.async=!1,i.dataset.dominicSrc=e,i.onload=()=>{i.dataset.loaded=`1`,t()},i.onerror=()=>n(Error(`Không tải được ${e}`)),document.body.appendChild(i)})}function c(){return(0,r.useEffect)(()=>{let e=!1;return(async()=>{try{for(let t of o)if(await s(t),e)return;window.startDominic?.()}catch(t){if(e)return;let n=document.getElementById(`content`);n&&(n.innerHTML=`<div class="err">Không khởi động được ứng dụng: ${t instanceof Error?t.message:String(t)}</div>`)}})(),()=>{e=!0}},[]),(0,a.jsx)(`div`,{className:`dominic-host`,dangerouslySetInnerHTML:{__html:i}})}function l(){return(0,a.jsx)(c,{})}export{l as component};
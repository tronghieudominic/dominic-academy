...
//#region node_modules/.nitro/vite/services/ssr/assets/router-4T4vxVHx.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var FALLBACK_MESSAGE = "Đã xảy ra lỗi. Hãy tải lại trang và thử lại.";
...
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-screen flex-col items-center justify-center gap-3 bg-[#F5F7FB] px-6 text-center text-[#0F172A]",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-[#3B8FC4]",
				"aria-hidden": "true",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-md text-sm break-words text-[#64748B]",
...
var styles_default = "/assets/styles-B3ROs7Y8.css";
var APP_NAME = "Dominic Academy";
...
var $$splitComponentImporter = () => import("./routes-wtURylVL.mjs");
...
function isAllowedHost(hostname) {
	...
	if (h.endsWith(".amazonaws.com") && (h.includes("s3") || h.includes("izteach"))) return true;
	return false;
}
var PASS_REQUEST = [
	"authorization",
...
async function proxyIzteach(request) {
	...
	if (parsed.protocol !== "https:" && parsed.protocol !== "http:") return Response.json({ error: "Unsupported protocol" }, { status: 400 });
	if (!isAllowedHost(parsed.hostname)) return Response.json({ error: "Host not allowed" }, { status: 403 });
...
var Route = createFileRoute("/api/izteach")({ server: { handlers: {
